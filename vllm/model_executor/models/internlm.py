...
# Copyright 2023 wangruohui

"""Inference-only InternLM model compatible with HuggingFace weights.
    ...
    def load_weights(self,
        ...
        for name, loaded_weight in hf_model_weights_iterator(
            ...
            for stride_id, att_weight_name in enumerate(
                ...
                # print(att_weight_name, 'in' ,name, "param", name.replace(att_weight_name, "qkv_proj"), param.shape[0])
